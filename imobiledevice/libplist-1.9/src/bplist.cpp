...
{
    void *src;
    unsigned __int8 *u8ptr;
    unsigned __int16 *u16ptr;
    unsigned __int32 *u32ptr;
    unsigned __int64 *u64ptr;
};
...
static plist_t parse_uint_node(char *bnode, unsigned __int8 size, char **next_object)
{
