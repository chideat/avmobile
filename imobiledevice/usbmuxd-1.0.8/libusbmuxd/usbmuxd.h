 ...
 */
int usbmuxd_send(int sfd, const char *data, unsigned __int32 len, unsigned __int32 *sent_bytes);
 ...
 * @return 0 on success, a negative errno value otherwise.
 */
int usbmuxd_recv_timeout(int sfd, char *data, unsigned __int32 len, unsigned __int32 *recv_bytes, unsigned int timeout);
 ...
 * @return 0 on success, a negative errno value otherwise.
 */
int usbmuxd_recv(int sfd, char *data, unsigned __int32 len, unsigned __int32 *recv_bytes);
